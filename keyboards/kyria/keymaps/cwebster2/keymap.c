 ...
 */
 ...
 /* ,-----------------------.                 ,-----------------------. */
      _______INACTIVE_L1____,                 _______FN_______R1____,
      _______INACTIVE_L2____,                 _______FN_______R2____,
      _______INACTIVE_L3____,                 _______FN_______R3____,
              _______INACTIVE__T____,  _______FN________T____
 /*           `---------------------'  `---------------------' */
      ),
    [_SYMBOLS] = LAYOUT_kyria_base_wrapper(
 /* ,-----------------------.                 ,-----------------------. */
      _______INACTIVE_L1____,                 _______SYM______R1____,
      _______INACTIVE_L2____,                 _______SYM______R2____,
      _______INACTIVE_L3____,                 _______SYM______R3____,
              _______INACTIVE__T____,  _______SYM_______T____
 /*           `---------------------'  `---------------------' */
    ),
    [_NUM] = LAYOUT_kyria_base_wrapper(
 /* ,-----------------------.                 ,-----------------------. */
      _______INACTIVE_L1____,                 _______NUM______R1____,
      _______INACTIVE_L2____,                 _______NUM______R2____,
      _______INACTIVE_L3____,                 _______NUM______R3____,
              _______INACTIVE__T____,  _______NUM_______T____
 /*           `---------------------'  `---------------------' */
      ),
    [_NAV] = LAYOUT_kyria_base_wrapper(
 /* ,-----------------------.                 ,-----------------------. */
      _______NAV______L1____,                 _______INACTIVE_R1____,
      _______NAV______L2____,                 _______INACTIVE_R2____,
      _______NAV______L3____,                 _______INACTIVE_R3____,
              _______NAV_______T____,  _______INACTIVE__T____
 /*           `---------------------'  `---------------------' */
      ),
    [_MOUSE] = LAYOUT_kyria_base_wrapper(
 /* ,-----------------------.                 ,-----------------------. */
      _______MOUSE____L1____,                 _______INACTIVE_R1____,
      _______MOUSE____L2____,                 _______INACTIVE_R2____,
      _______MOUSE____L3____,                 _______INACTIVE_R3____,
              _______MOUSE_____T____,  _______INACTIVE__T____
 /*           `---------------------'  `---------------------' */
      ),
    [_MEDIA] = LAYOUT_kyria_base_wrapper(
 /* ,-----------------------.                 ,-----------------------. */
      _______MEDIA____L1____,                 _______INACTIVE_R1____,
      _______MEDIA____L2____,                 _______INACTIVE_R2____,
      _______MEDIA____L3____,                 _______INACTIVE_R3____,
              _______MEDIA_____T____,  _______INACTIVE__T____
 /*           `---------------------'  `---------------------' */
     ),
};
